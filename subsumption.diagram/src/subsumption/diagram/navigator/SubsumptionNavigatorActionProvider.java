...
import subsumption.diagram.part.SubsumptionDiagramEditor;
 ...
 * @generated
 */
public class SubsumptionNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof SubsumptionNavigatorItem) {
					selectedElement = ((SubsumptionNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (SystemEditPart.MODEL_ID
							.equals(SubsumptionVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, SubsumptionDiagramEditor.ID);
