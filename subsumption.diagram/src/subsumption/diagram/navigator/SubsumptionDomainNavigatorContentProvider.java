 ...
 * @generated
 */
public class SubsumptionDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SubsumptionDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof SubsumptionDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((SubsumptionDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new SubsumptionDomainNavigatorItem(
