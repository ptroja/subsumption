...
import subsumption.diagram.edit.commands.ModuleCreateCommand;
...
public class SystemItemSemanticEditPolicy extends
	...
	public SystemItemSemanticEditPolicy() {
		super(SubsumptionElementTypes.System_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (SubsumptionElementTypes.Module_2001 == req.getElementType()) {
