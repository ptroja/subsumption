...
import subsumption.diagram.edit.policies.SubsumptionTextSelectionEditPolicy;
 ...
 * @generated
 */
public class OutputNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				SubsumptionVisualIDRegistry
						.getType(subsumption.diagram.edit.parts.OutputNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SubsumptionTextSelectionEditPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof SubsumptionTextSelectionEditPolicy) {
			((SubsumptionTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof SubsumptionTextSelectionEditPolicy) {
			((SubsumptionTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SubsumptionParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					SubsumptionEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new IONameFigure();
	}

	/**
	 * @generated
	 */
	public class IONameFigure extends WrappingLabel {
