 ...
 * @generated
 */
public class SubsumptionEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case SuppressorEditPart.VISUAL_ID:
				return new SuppressorEditPart(view);

			case SuppressorTimeEditPart.VISUAL_ID:
				return new SuppressorTimeEditPart(view);
			...
			case InhibitorEditPart.VISUAL_ID:
				return new InhibitorEditPart(view);

			case InhibitorTimeEditPart.VISUAL_ID:
				return new InhibitorTimeEditPart(view);

			case InputInputCompartmentEditPart.VISUAL_ID:
				return new InputInputCompartmentEditPart(view);

			case OutputOutputCompartmentEditPart.VISUAL_ID:
				return new OutputOutputCompartmentEditPart(view);

			case OutputSinkEditPart.VISUAL_ID:
				return new OutputSinkEditPart(view);

			case OutputActivatesEditPart.VISUAL_ID:
				return new OutputActivatesEditPart(view);
