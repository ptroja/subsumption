 ...
 * @generated
 */
public class SubsumptionInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SubsumptionNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemEditPart.MODEL_ID));
		SubsumptionDiagramEditorUtil.runWizard(getShell(), wizard,
