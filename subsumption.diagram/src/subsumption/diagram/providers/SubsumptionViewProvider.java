 ...
 * @generated
 */
public class SubsumptionViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SubsumptionVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = SubsumptionVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!SubsumptionElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != SubsumptionVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!SystemEditPart.MODEL_ID.equals(SubsumptionVisualIDRegistry
		...
		return ModuleEditPart.VISUAL_ID == visualID
				|| InputEditPart.VISUAL_ID == visualID
				|| SuppressorEditPart.VISUAL_ID == visualID
				|| OutputEditPart.VISUAL_ID == visualID
				|| InhibitorEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = SubsumptionVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != SubsumptionVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = SubsumptionVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ModuleEditPart.VISUAL_ID:
			return createModule_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case InputEditPart.VISUAL_ID:
			return createInput_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case SuppressorEditPart.VISUAL_ID:
			return createSuppressor_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case OutputEditPart.VISUAL_ID:
			return createOutput_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case InhibitorEditPart.VISUAL_ID:
			return createInhibitor_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SubsumptionVisualIDRegistry.getVisualID(elementTypeHint)) {
		case OutputSinkEditPart.VISUAL_ID:
			return createOutputSink_4001(containerView, index, persisted,
					preferencesHint);
		case OutputActivatesEditPart.VISUAL_ID:
			return createOutputActivates_4002(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createModule_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SubsumptionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createSuppressor_3003(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createInhibitor_3004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SubsumptionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createOutputSink_4001(View containerView, int index,
		...
		edge.setType(SubsumptionVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createOutputActivates_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
