...
/**
 * This is the item provider adapter for a {@link subsumption.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SubsumptionPackage.Literals.OUTPUT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSinkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_sink_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_sink_feature", "_UI_Output_type"),
				 SubsumptionPackage.Literals.OUTPUT__SINK,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActivatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_activates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_activates_feature", "_UI_Output_type"),
				 SubsumptionPackage.Literals.OUTPUT__ACTIVATES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SubsumptionPackage.Literals.OUTPUT__INHIBITED_BY);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(SubsumptionPackage.Literals.OUTPUT__INHIBITED_BY,
				 SubsumptionFactory.eINSTANCE.createInhibitor()));
	}
