...
/**
 * This is the item provider adapter for a {@link subsumption.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SubsumptionPackage.Literals.INPUT__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SubsumptionPackage.Literals.INPUT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SubsumptionPackage.Literals.INPUT__SUPPRESSED_BY);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(SubsumptionPackage.Literals.INPUT__SUPPRESSED_BY,
				 SubsumptionFactory.eINSTANCE.createSuppressor()));
	}
